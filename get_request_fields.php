...
$results =  $wpdb->get_row("SELECT * FROM wp_request_fields WHERE service_id = '".$service_id."' AND category_id = '".$category_id."' LIMIT 1");
$request_fields = $results->request_fields;
