...
<body>
  ...
  $resultsdona = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}campaigndonations WHERE campaign_Id IN(" . $id . ") and status = 1");
                ...
                <div id="Description">
                  ...
                  <div class="tp-case-content">
                    <div class="tp-case-text-top">
                      ...
                      <div style="margin-bottom:20px"><img src="<?php echo bloginfo('template_directory'); ?>/images/date.png" width="30"> 18 Jan 2021 <span style="margin-left:20px"><img src="<?php echo bloginfo('template_directory'); ?>/images/type.png" width="30"> Campaign Type</span></div>
                      ...
                      <ul>
                        <li><span>Raised:</span> <?= $currency; ?><?php echo $achieve_amount ? $achieve_amount : 0; ?></li>
                        <li><span>Goal:</span> <?= $currency; ?><?php echo $goal_amount; ?></li>
                        <?php
                        if ($res->id == 24) {
                          ?>
                          <li><span>Donar:</span> 5</li>
                        <?php
                        } else if ($res->id == 25) {
                          ?>
                          <li><span>Donar:</span> 2</li>
                        <?php
                        } else {
                          ?>
                          <li><span>Donar:</span> <?php echo count($resultsdona); ?></li>
                        <?php
                        }
                        ?>
                      </ul>
              ...
              <div class="p-1 mt-1 mb-3 d-none d-sm-block box-stick__border-light">
                ...
                <div class="h-100 d-inline-block w-100 align-top mt-0 side-t-con text-center ">
                  <h4 class="d-block box-stick__color-grey text-center ">
                    <span class="custom-raisedAmount" style="font-weight:700"> <?= $currency; ?><?php echo $achieve_amount ? $achieve_amount : 0; ?> Raised</span>
                    <span class="box-stick__color-light">of <?= $currency; ?><?php echo $goal_amount; ?></span>
                  </h4>
                </div>
                  ...
                  <div class="posts">
                    <?php
                      ...
                      <div class="post">
                        ...
                        <div class="details">
                          <h4>
                            <a href="#"><?php echo $resul->fullName; ?></a>
                          </h4>
                          <span class="date"><?php echo $currency . ' ' . $amount; ?></span>
                        </div>
                      </div>
                    <?php } ?>
                  </div>
                  ...
                  <div class="posts">
                    <div class="post">
                      ...
                      <div class="details">
                        ...
                        <span class="date">INR 20000</span>
                      </div>
                    </div>
                    <div class="post">
                      <div class="img-holder">
                      ...
                      <div class="details">
                        ...
                        <span class="date">INR 10000</span>
                      </div>
                    </div>
                    <div class="post">
                      <div class="img-holder">
