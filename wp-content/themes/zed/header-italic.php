                    ...
                    <ul class="header-contact">
                        ...
                        <li>
                            ...
                            <div class="icon-info">
                                ...
                                <span><a style="color: #42474c !important;" href="http://localhost/blue/homepage-italian/">ITALIAN</a> <i class="fa fa-angle-down"></i></span>
	...
	<span style="padding-left:0px !important;background:none"><a style="color: #42474c !important;" href="http://localhost/blue/">ENGLISH</a></span>
                        ...
                        <li>
                            ...
                            <div class="icon-info">
                                ...
                                <b>Orario di apertura
</b>

                                <span>Dal lunedì al sabato: dalle 9:00 alle 18:00
</span>
        ...
        <a href="<?= BASE_URL; ?>flex-payments/" class="btn flex-payment responsve-fp">Pagamento flessibile
</button>
                    ...
                    <div class="navbar">
                        ...
                        <nav>
                            ...
                            <ul>
                                ...
                                <li><a href="<?= BASE_URL; ?>about-us/" class="<?= $slug == 'about-us' ? "active" : ""; ?>">Chi siamo
</a></li>

                                <li class="dropdown"><a href="javascript:void(0)" class="<?= $slug == 'our-services' ? "active" : ""; ?>">Trapianto di capelli
 <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<?= BASE_URL; ?>packages-and-services/hair-transplant/">Trapianto di capelli
</a></li>
                                        <li><a href="<?= BASE_URL; ?>packages-and-services/fue-hair-transplant/">Trapianto di capelli FUE con zaffiro
</a></li>
                                        <li><a href="<?= BASE_URL; ?>packages-and-services/dhi-hair-transplant/">Trapianto di capelli DHI
</a></li>
                                        <li><a href="<?= BASE_URL; ?>packages-and-services/hair-transplant-for-women/">Trapianto di capelli per le donne
</a></li>
                                        <li>
                                            <a href="<?= BASE_URL; ?>packages-and-services/manual-hair-transplant/">Trapianto di capelli manuale
 &nbsp;
                                                <button class="btn" style="background: #D1372A; margin-top: -2px; padding-right: 14px; padding-left: 14px; padding-top: 4px; padding-bottom: 3px; position: absolute;font-size: 11px; color: white;">Esclusiva</button>
                                            </a>
                                        </li>
                                        <li><a href="<?= BASE_URL; ?>packages-and-services/afro-hair-transplant/">Trapianto di capelli afro
</a></li>
                                        <li><a href="<?= BASE_URL; ?>packages-and-services/beard-transplantation/">Trapianto di barba
</a></li>
                                        <li><a href="<?= BASE_URL; ?>packages-and-services/eyebrow-transplantation/">Trapianto di sopracciglia
</a></li>
                                        <li><a href="<?= BASE_URL; ?>packages-and-services/prp-therapy/">Trattamento per capelli Prp
</a></li>
                                    </ul>
                                </li>

                                <li class="dropdown"><a href="javascript:void(0)" class="<?= $slug == 'results-final' ? "active" : ""; ?>">Risultati <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<?= BASE_URL; ?>results-final/">Risultati</a></li>
                                        <li><a href="<?= BASE_URL; ?>testimonial/">Testimonianze</a></li>
                                    </ul>
                                </li>

                                <!--<li><a href="<?= BASE_URL; ?>results-final/" class="<?= $slug == 'results-final' ? "active" : ""; ?>">Results</a></li>-->

                                <li class="dropdown"><a href="javascript:void(0)" class="<?= ($slug == 'before-hair-transplant-operation') || ($slug == 'faq') || ($slug == 'hair-transplantation-turkey')   ? "active" : ""; ?>">Guida per il paziente
 <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<?= BASE_URL; ?>before-hair-transplant-operation/" class="<?= $slug == 'before-hair-transplant-operation' ? "active" : ""; ?>">Prima del trapianto di capelli
</a></li>
                                        <li><a href="<?= BASE_URL; ?>after-hair-transplant-operation/" class="<?= $slug == 'after-hair-transplant-operation' ? "active" : ""; ?>">Dopo il trapianto di capelli
</a></li>
                                        <li><a href="<?= BASE_URL; ?>post-operative-hair-wash/">Lavaggio dei capelli post-operatorio
</a></li>
                                        <li><a href="<?= BASE_URL; ?>hair-transplantation-turkey/" class="<?= $slug == 'hair-transplantation-turkey' ? "active" : ""; ?>">Trapianto di capelli in Turchia
</a></li>
                                ...
                                <li class="dropdown"><a href="javascript:void(0)" class="<?= ($slug == 'press-and-award') || ($slug == 'our-book') || ($slug == 'bluemagic-experience') || ($slug == 'our-media') ? "active" : ""; ?>">Media <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="<?= BASE_URL; ?>press-and-award/">Comunicato stampa
</a></li>
                                        <li><a href="<?= BASE_URL; ?>experience/">The BlueMagic Group Experience</a></li>
                                        <li><a href="<?= BASE_URL; ?>our-media/">Foto/Videos</a></li>
                                        <!-- <li><a href="<?= BASE_URL; ?>our-media/">Videos</a></li> -->
                                        <li><a href="<?= BASE_URL; ?>our-book/">Il nostro libro
</a></li>
                                    </ul>
                                </li>
                                ...
                                <li><a href="<?= BASE_URL; ?>contact-us/" class="<?= $slug == 'contact-us' ? "active" : ""; ?>">Contattaci</a></li>
                    ...
                    <a href="<?= BASE_URL; ?>flex-payments/" class="btn flex-payment">Pagamento flessibile
</button>
