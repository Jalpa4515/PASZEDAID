                            ...
                            if ($results) {
                                foreach ($results as $res) {
                                    ...
                                    if ($res->video) {
                                        ...
                                        $iimage = BASE_URL . 'fundraiserimg/' . $tt ['image'];
                                    }
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                                        <div class="cause-item">
                                            ...
                                            <div class="cause-text">
                                                ...
                                                <div class="pbar2">
                                                    <div> <?php echo $currency." ".number_format(str_ireplace(",","", $achieve_amount)); ?>
                                                        <div>Raised</div>
                                                        <!-- <div style="font-size: 11px;">Online: <?= $currency." ".number_format(str_ireplace(",","", $achieve_amount_online)); ?></div>
                                                        <div style="font-size: 11px;">Offline: <?= $currency." ".number_format(str_ireplace(",","", $achieve_amount_offline)); ?></div> -->
                                                    </div>
                                                    <!--<div><span>Raised:</span> <?php echo $currency.number_format(str_ireplace(",","", $achieve_amount)); ?></div>-->

                                                    <?php if($achieve_amount > $goal_amount){?>
                                                        <div> <?php echo $currency." ".number_format(str_ireplace(",", "", $achieve_amount)); ?><div>Goal</div></div>
                                                    <?php } else { ?>
