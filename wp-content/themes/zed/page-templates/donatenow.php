        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    ?>
                    <form class="tp-accountWrapper" id="frmDonation" method="post" action="<?php echo BASE_URL; ?>submitdonate2.php">
                        ...
                        <div class="tp-accountForm form-style">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-12 col-12 col-sm-9" style="padding-left: 0px;">
                                <input type="text" id="amount" name="amount" placeholder="How much do you want to donate?" class="num" maxlength="10">    
                                </div>
                                <div class="col-lg-12 col-md-12 col-12">
                                    <input type="text" id="address" name="address" placeholder="Enter Address">
                                </div>
                                <?php if($role == 'administrator' || $camp_user_id == $current_user_id){?>
                                <div class="col-lg-12 col-md-12 col-12">
