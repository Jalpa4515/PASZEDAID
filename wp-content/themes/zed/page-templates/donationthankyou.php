          ...
          <div class="col col-md-12" style="text-align: center;">
            <div class="tp-case-details-wrap">
              <div class="tp-case-details-text">                
                ...
                <h2 style="text-align: center;margin-top:35px;margin-bottom: 20px;color:#3D3D8A">Thank you for the donation and impacting the #ZEDLives.</h2>
<!--                   <div class="tp-case-details-img">
                    <img src="<?php echo $iimage; ?>" alt="" />
                  </div>
                  <div class="tp-case-content">
                    <div class="tp-case-text-top">
                      <h3><b>Campaign Title:</b> <span style="font-size:25px"><?php echo $fundtitle; ?></span></h3>
