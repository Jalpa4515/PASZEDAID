...
error_reporting(0);
/**
 * Template Name: Service Listing Admin
 *
 * @package WordPress
                        ...
                        <div class="tp-blog-sidebar">
                            <div class="widget category-widget">
                                <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php foreach($resultsdonacc as $val){?>
                                        <tr>
                                            <td>
                                            <img src="<?= BASE_URL?>/wp-content/uploads/services/<?= $val['banner'];?>" width="50">
                                            </td>
                                            <td>
                                            <?= $val['service_name'];?>
                                            </td>
                                            ...
                                            <td>
                                            <span class="licause"><a href="<?= BASE_URL?>service-detail-admin/?slug=<?= $val['id'];?>">View Details</a></span>
                                            </td>
                                        </tr>
                                        <?php } ?>
