      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <form enctype="multipart/form-data" method="post" id="form1" class="tp-accountWrapper">
            ...
            <div class="tp-accountForm form-style">
              ...
              <?php if($role == 'administrator' || $camp_user_id == $userId){?>
              <div class="col-lg-12 col-md-12 col-12">
                  <input type="checkbox" id="payment_type" name="payment_type" value="2">
                  <label style="margin-left:25px;" for="payment_type">Offline Payment</label>
              </div>
              <?php } else {?>
                  <input type="hidden" id="payment_type" name="payment_type" value="1">
              <?php } ?>

              <input type="hidden" name="amount_max_value" id="amount_max_value" value="<?= $amount_max_value; ?>">
        ...
        <script>
          $(document).ready(function() {
            var amount_max_value = $('#amount_max_value').val();
            ...
            $("#payment_type").click(function(){
              if($(this).is(":checked")) {
                var amount_max_value = "1000000000000";
                $('#amount').rules('add', {range: [1,1000000000]});
              }else{
                var amount_max_value = $('#amount_max_value').val();
                $('#amount').rules('add', {range: [1,amount_max_value]});
              }
            });  
