...
<!-- start of hero -->
<section class="hero hero-style-2 heros1" style="height:780px">
    <div class="hero-slider" style="height:780px">
        <div class="slide" style="height:700px !important;margin-top: 90px;">            
            <img src="https://zedaid.org/wp-content/uploads/2021/07/Copy-of-Share-A-Smile.png"/>
        </div>
        <div class="slide" style="height:700px !important;margin-top: 90px;">
            <img src="https://zedaid.org/wp-content/uploads/2021/07/Share-A-Smile.png" />
        </div>
        <div class="slide" style="height:700px !important;margin-top: 90px;">
            <img src="https://zedaid.org/wp-content/uploads/2021/07/Copy-of-Copy-of-Share-A-Smile.png"/>         
        </div>        
    </div>
</section>
<!-- end of hero slider -->
<section class="hero hero-style-2 heros">
    <div class="hero-slider">
        <div class="slide" style="height:700px">
            <div class="container">
                <img src="https://zedaid.org/wp-content/uploads/2021/07/New-Project.png" alt class="slider-bg" />
                <div class="row">
        ...
        <div class="slide" style="height:700px;">
            <div class="container">
                <img src="https://zedaid.org/wp-content/uploads/2021/07/New-Project-1.png" alt class="slider-bg" />
                <div class="row">
                    <div class="col col-md-6 slide-caption" style="float: right;">
                        <div class="slide-title">
        ...
        <div class="slide" style="height:700px;">
            <div class="container">
                <img src="https://zedaid.org/wp-content/uploads/2021/07/New-Project-2.png" alt class="slider-bg" />
                <div class="row">
                    <div class="col col-md-6 slide-caption" style="float: left;">
                        <div class="slide-title">
                            <h2>Collaborative Channel <span> across locations</span> for campaigns</h2>
                        </div>
                        <!-- <div class="slide-subtitle">
                    <p>High Quality Charity Theme in Envato Market.</p>
                    <p>You Can Satisfied Yourself By Helping.</p>
                  ...
                  <div class="btns">
                    <a href="donate.html" class="theme-btn">Donate Now</a> a  for campai                               href="about.html" class="theme-btn-s2">Know More</a>
                  </div> -->
                    </div>
                </div>
            </div>
...
$resultsdonacc = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}campaigndonations WHERE ((paymetStatus = 1 AND campaign_typeId = 1) OR campaign_typeId != 1) AND status = 1", ARRAY_A);
...
<div class="case-area section-padding">
    <div class="container">
        ...
        <?php
            $results = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}campaigns WHERE admin_approved = 1 order by CAST(achieve_amount AS DECIMAL(10,2)) DESC limit 3", OBJECT);
        ?>
        <div <?php if(count($results) > 2){?> class="row" <?php }else{ ?> class="col-md-12 col-md-offset-2"<?php } ?>>
            <?php
                            ...
                            <div class="details">
                                ...
                                <ul class="entry-meta">
                                    <li>
                                        ...
                                        <Span class="white-color">By </span> <a href="javascript:void(0)">ZedAid</a>
                                    </li>
                                    <li><?= $dates; ?></li>
                                </ul>
                            </div>
            ...
            <div class="col col-xs-12 teamcenter">
                <div class="team-grids clearfix temcenter2">
                    <div class="grid">
                        ...
                        <div class="details">
                            <p><h3 class="white-color">Mrs. Kiran Tushar Gangurde</h3></p>
                            <p>Founder</p>
                        </div>
                    </div>
                    <div class="grid">
                        ...
                        <div class="details">
                            <p><h3 class="white-color">Mrs. Rajani Bharat Gangurde</h3></p>
                            <p>Co-Founder</p>
                        </div>
                    </div>
                    <!-- <div class="grid">
