...
function shorturl($url){
	$curl = curl_init();
	$jobid = rand(111111,9999999);
	curl_setopt_array($curl, array(
	CURLOPT_URL => 'https://67ya0l658d.execute-api.ap-south-1.amazonaws.com/dev/url_meta/',
	...
	"long_url": "'.$url.'",
	"mobile": [
		{"mobile":"1234567890","contactid":1234567890}
	],
	"jobid": '.$jobid.'
	}',
	...
	$short_url_list = $result['short_url_list'];
