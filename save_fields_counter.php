...
$results1 =  $wpdb->get_results("SELECT * FROM wp_counter_fields WHERE category_id =" .$category_id);

if(!empty($results1)){

    $resultsc = $wpdb->get_results("UPDATE wp_counter_fields SET banner1 = '".$banner_label1."', banner2 = '".$banner_label2."', banner3 = '".$banner_label3."', counter1 = '".$select_drop1."', counter2 = '".$select_drop2."', counter3 = '".$select_drop3."',counter1_label = '".$opt_name1."', counter2_label = '".$opt_name2."', counter3_label = '".$opt_name3."'  WHERE category_id =" .$category_id);
...
$results =  $wpdb->get_results("SELECT * FROM wp_counter_fields WHERE category_id = '".$category_id."' ORDER BY id ASC",ARRAY_A);
