...
if($payment_type == '2'){
    ...
    $sqli = "INSERT INTO wp_campaigndonations (userId,razorpay_order_id,invoice_id,paymetStatus,campaign_Id, campaign_typeId, `anonymous`, fullName, emailId, phonenumber, address, campaignCreator, zed, zedFoundation, amount, `status`,latitude,longitude,payment_type,razorpay_payment_id) VALUES ('" . $userId . "','".$razorpayOrderId."','0','2','" . $campaign_Id . "','" . $campaign_typeId . "','" . $anonymous . "','" . $fullName . "','" . $emailId . "','" . $phonenumber . "','" . $address . "','" . $zedprice2 . "','" . $perc . "','" . $perc2 . "','" . $_POST['amount']. "','1','" . $latitude . "','" . $longitude . "','".$payment_type."','".$razorpay_payment_id."')";
    $conn->query($sqli);

    header("Location: http://3.7.53.246/zedaid/verifyOffline.php?campaign_Id=".$campaign_Id."&razorpay_order_id=".$razorpayOrderId);
}else{
    $sqli = "INSERT INTO wp_campaigndonations (userId,razorpay_order_id,invoice_id,paymetStatus,campaign_Id, campaign_typeId, `anonymous`, fullName, emailId, phonenumber, address, campaignCreator, zed, zedFoundation, amount, `status`,latitude,longitude,payment_type) VALUES ('" . $userId . "','".$razorpayOrderId."','0','2','" . $campaign_Id . "','" . $campaign_typeId . "','" . $anonymous . "','" . $fullName . "','" . $emailId . "','" . $phonenumber . "','" . $address . "','" . $zedprice2 . "','" . $perc . "','" . $perc2 . "','" . $_POST['amount']. "','1','" . $latitude . "','" . $longitude . "','".$payment_type."')";
    $conn->query($sqli);
}
