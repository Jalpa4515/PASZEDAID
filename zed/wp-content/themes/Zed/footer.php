    ...
    <div class="container">
        ...
        <div class="footer-col box2">
            ...
            <ul class="quick-links-list">
                ...
                <li><a href="<?= BASE_URL; ?>before-hair-transplant-operation/"><i class="fa fa-angle-right "></i>Before & After</a></li>
                <li><a href="<?= BASE_URL; ?>packages-and-services/fue-hair-transplant/"><i class="fa fa-angle-right "></i>Micro FUE Sapphire
                    </a></li>
                <li><a href="<?= BASE_URL; ?>our-media/"><i class="fa fa-angle-right "></i>Videos</a></li>
                <li><a href="<?= BASE_URL; ?>packages-and-services/dhi-hair-transplant/"><i class="fa fa-angle-right "></i>DHI Choi Pen</a></li>
                <li><a href="<?= BASE_URL; ?>about-us/"><i class="fa fa-angle-right "></i>About us</a></li>
                <li><a href="<?= BASE_URL; ?>packages-and-services/prp-therapy/"><i class="fa fa-angle-right "></i>PRP Therapy</a></li>
                ...
                <li><a href="<?= BASE_URL; ?>experience/"><i class="fa fa-angle-right "></i>Experience</a></li>
                <li><a href="<?= BASE_URL; ?>contact-us/"><i class="fa fa-angle-right "></i>Contact us</a></li>
            </ul>
        </div>
        <div class="footer-col box3">
            <p>All procedures are completed at a JCI accredited facility and protected by our golden lifetime guarantee</p>
            <ul class="bagde-list">
                <li>
