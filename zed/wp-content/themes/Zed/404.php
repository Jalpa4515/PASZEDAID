    ...
    <section class="info-text-wrapper">
        <div class="container">
            <span class="thank-you-image">
                <img src="<?php echo bloginfo('template_directory'); ?>/images/404-Not-Found.png" alt="404-Not-Found" />
            </span>
            <h3>oh! no! page not found</h3>
            <p>The page you’re looking for isn’t available. Try your search again or <br /> use the Go Home button below</p>
