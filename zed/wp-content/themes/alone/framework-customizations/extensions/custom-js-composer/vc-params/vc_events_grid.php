            ...
            'params' => array(
              ...
              array(
                ...
                'value' => array(
                  ...
                  'style2' => get_template_directory_uri() . '/framework-customizations/extensions/custom-js-composer/images/layouts/event-slider-layout-style-1.png',
                ),
                'std' => 'default',
                ...
                '<div class="item-inner grid-item layout-{layout}">',
                  '<div class="bg-grid">',
                    ...
                    '<div class="content-entry">',
                      ...
                      '<p class="alone-excerpt">{post_excerpt}</p>',
                      '<a href="{post_link}" class="more-link">More Information <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>',
                    '</div>',
                  '</div>',
                '</div>',
              ));
