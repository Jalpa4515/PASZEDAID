...
if(! function_exists('_the_bears_filter_fw_ext_backups_demos')) :
	...
	function _alone_filter_fw_ext_backups_demos($demos)
	{
		$demos_array = array(
			'alone-vote' => array(
				'title' => esc_html__('Alone Vote', 'alone'),
				'screenshot' => 'http://package.bearsthemes.com/alone/alone-vote/screenshot.jpg',
				'preview_link' => 'https://bearsthemes.com/themes/alone-vote/',
			),
