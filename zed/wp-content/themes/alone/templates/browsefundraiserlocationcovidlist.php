...
<section class="bt-main-row bt-section-space sidebar-right" role="main" itemprop="mainEntity" itemscope="itemscope" itemtype="http://schema.org/Give">
    <div class="container">
                    ...
                    function setMap(mapCenter, latitude = 0, longitude = 0, locations = '', search = '') {
                        ...
                        var locations = [
                            ...
                            foreach ($results as $res) {
                                ...
                                //$categoryName = '<span style="color:#2EC4F7 !important; float: left;">' . $res['categoryName'] . '</span> <span style="color:#2EC4F7 !important; float: right;cursor: pointer;"><a href="#" class="btn" style="color:#2EC4F7 !important;" onclick="openPopup('.$pid.','.$status.');">Change Status</a></span>';

                                $categoryName = '<span style="color:#2EC4F7 !important; float: left;">' . $res['categoryName'] . '</span>';
        ...
        <div class="text-center">
            <button type="button" id="links" class="btn enquire-btn" data-toggle="modal" data-target="#myModal2" style="background: #0ec4f7; color: black;">
                Useful Links
            </button>

            <button type="button" id="contacts" class="btn enquire-btn2" data-toggle="modal" data-target="#myModal3" style="background: #0ec4f7; color: black;">
                Useful Contacts
            </button>
        </div>
...
<script>
    function openPopup(pid, status){
        ...
        if(status == 1){
            ...
            jQuery('.status-tobeavailable').remove();
            jQuery('.status-notavailable').remove();
        }else if(status == 2){
            jQuery('.status-available').remove();
