...
$subjectnn = "ZED$lastid - $campt - $fundtitle - $address - Has been initiated and waiting for ZedAid approval, it may take 48 hours to activate. Link : $shorturl";
$to2 = $user_emailu;
...
curl_setopt_array($curl2, array(
    ...
    CURLOPT_POSTFIELDS => "{\"sender\":\"ZEDAID\",\"route\":\"1\",\"country\":\"91\",\"DLT_TE_ID\":\"1307162620976143979\",\"sms\":[{\"message\":\"$subjectnn\",\"to\":[\"$phoneu\"]}]}",
...
$shorturl = shorturl($detaillink);
$smstextAdmin = 'Dear Admin, you have received a new campaign for approval on ZedAid. Kindly approve. Link : '.$shorturl;
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
    CURLOPT_CUSTOMREQUEST => "POST",
    CURLOPT_POSTFIELDS => "{\"sender\":\"ZEDAID\",\"route\":\"1\",\"country\":\"91\",\"DLT_TE_ID\":\"1307163394000623430\",\"sms\":[{\"message\":\"$smstextAdmin\",\"to\":[\"9408781162\"]}]}",
    CURLOPT_HTTPHEADER => array(
        "authkey: 328268AQTjWikZLti61725bd1P1",
        "cache-control: no-cache",
        "content-type: application/json",
