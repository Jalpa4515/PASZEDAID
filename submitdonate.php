...
if ($payment_type == '2') {
    $sql2 = $wpdb->prepare(
        "INSERT INTO `wp_campaigndonations` (campaign_Id, campaign_typeId, anonymous, fullName, emailId, phonenumber, address, amount,latitude,longitude,payment_type,`status`) 
 values ('" . $campaign_Id . "','" . $campaign_typeId . "','" . $anonymous . "','" . $fullName . "','" . $emailId . "','" . $phonenumber . "','" . $address . "','" . $amount . "','" . $latitude . "','" . $longitude . "','2','1')"
    );
    $wpdb->query($sql2);
}else{
    $sql2 = $wpdb->prepare(
        "INSERT INTO `wp_campaigndonations` (campaign_Id, campaign_typeId, anonymous, fullName, emailId, phonenumber, address, amount,latitude,longitude,payment_type) 
 values ('" . $campaign_Id . "','" . $campaign_typeId . "','" . $anonymous . "','" . $fullName . "','" . $emailId . "','" . $phonenumber . "','" . $address . "','" . $amount . "','" . $latitude . "','" . $longitude . "','1')"
    );
    $wpdb->query($sql2);
}
