    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          ...
          ?>
          <form enctype="multipart/form-data" method="post" id="form1" class="tp-accountWrapper dmain">
            ...
            <div class="tp-accountForm form-style dform">
              ...
              <div class="col-lg-12 col-md-12 col-12">
                ...
                <button type="button" id="target" class="tp-accountBtn btn-top">Submit</button>
              </div>
            </div>
